            ...
            <g className="cls-6">
              <g className="cls-7">
                <g>
                  ...
                  <polygon className="cls-4" points="5.79 1.61 6.75 3.28 7.72 1.61 5.79 1.61" />
                  <polygon className="cls-4" points="7.72 1.61 8.69 3.28 9.66 1.61 7.72 1.61" />
                  <polygon className="cls-4" points="9.66 1.61 10.63 3.28 11.6 1.61 9.66 1.61" />
                  <polygon className="cls-5" points="11.6 1.61 12.57 3.28 13.54 1.61 11.6 1.61" />
                  <polygon className="cls-4" points="13.54 1.61 14.51 3.28 15.48 1.61 13.54 1.61" />
                  <polygon className="cls-4" points="15.48 1.61 16.45 3.28 17.42 1.61 15.48 1.61" />
                  <polygon className="cls-4" points="17.42 1.61 18.39 3.28 19.36 1.61 17.42 1.61" />
                  <polygon className="cls-4" points="19.36 1.61 20.33 3.28 21.3 1.61 19.36 1.61" />
                  <polygon className="cls-4" points="21.3 1.61 22.27 3.28 23.24 1.61 21.3 1.61" />
                  <polygon className="cls-4" points="23.24 1.61 24.21 3.28 25.17 1.61 23.24 1.61" />
                  <polygon className="cls-5" points="25.17 1.61 26.14 3.28 27.11 1.61 25.17 1.61" />
                  ...
                  <polygon className="cls-4" points="22.26 6.62 21.29 4.95 20.32 6.62 22.26 6.62" />
                  <polygon className="cls-4" points="20.32 6.62 19.35 4.95 18.39 6.62 20.32 6.62" />
                  <polygon className="cls-4" points="18.39 6.62 17.42 4.95 16.45 6.62 18.39 6.62" />
                  <polygon className="cls-5" points="16.45 6.62 15.48 4.95 14.51 6.62 16.45 6.62" />
                  <polygon className="cls-5" points="14.51 6.62 13.54 4.95 12.57 6.62 14.51 6.62" />
                  ...
                  <polygon className="cls-4" points="-.03 4.95 .94 6.62 1.9 4.95 -.03 4.95" />
                  <polygon className="cls-4" points="1.9 4.95 2.87 6.62 3.84 4.95 1.9 4.95" />
                  <polygon className="cls-5" points="3.84 4.95 4.81 6.62 5.78 4.95 3.84 4.95" />
                  <polygon className="cls-4" points="5.78 4.95 6.75 6.62 7.72 4.95 5.78 4.95" />
                  <polygon className="cls-5" points="7.72 4.95 8.69 6.62 9.66 4.95 7.72 4.95" />
                  <polygon className="cls-4" points="9.66 4.95 10.63 6.62 11.6 4.95 9.66 4.95" />
                  <polygon className="cls-4" points="11.6 4.95 12.57 6.62 13.54 4.95 11.6 4.95" />
                  <polygon className="cls-4" points="13.54 4.95 14.51 6.62 15.48 4.95 13.54 4.95" />
                  <polygon className="cls-5" points="15.48 4.95 16.45 6.62 17.42 4.95 15.48 4.95" />
                  ...
                  <polygon className="cls-4" points="30.99 8.29 30.02 6.62 29.05 8.29 30.99 8.29" />
                  <polygon className="cls-5" points="29.05 8.29 28.08 6.62 27.12 8.29 29.05 8.29" />
                  <polygon className="cls-5" points="27.12 8.29 26.15 6.62 25.18 8.29 27.12 8.29" />
                  <polygon className="cls-4" points="25.18 8.29 24.21 6.62 23.24 8.29 25.18 8.29" />
                  ...
                  <polygon className="cls-4" points="8.7 6.62 9.67 8.29 10.63 6.62 8.7 6.62" />
                  ...
                  <polygon className="cls-4" points="28.09 9.96 27.12 8.29 26.15 9.96 28.09 9.96" />
                  <polygon className="cls-4" points="26.15 9.96 25.18 8.29 24.21 9.96 26.15 9.96" />
                  <polygon className="cls-4" points="24.21 9.96 23.24 8.29 22.27 9.96 24.21 9.96" />
                  <polygon className="cls-4" points="22.27 9.96 21.3 8.29 20.33 9.96 22.27 9.96" />
                  ...
                  <polygon className="cls-4" points="5.79 8.29 6.76 9.96 7.73 8.29 5.79 8.29" />
                  ...
                  <polygon className="cls-4" points="27.12 8.29 28.09 9.96 29.06 8.29 27.12 8.29" />
                  <polygon className="cls-4" points="29.06 8.29 30.03 9.96 30.99 8.29 29.06 8.29" />
                  <polygon className="cls-4" points="31 11.63 30.03 9.96 29.06 11.63 31 11.63" />
                  <polygon
                    className="cls-5"
                  ...
                  />
                  <polygon className="cls-4" points="22.27 13.3 21.3 11.63 20.33 13.3 22.27 13.3" />
                  <polygon
                    className="cls-4"
                  ...
                  />
                  <polygon className="cls-4" points="9.67 14.97 8.7 13.3 7.73 14.97 9.67 14.97" />
                  <polygon className="cls-4" points="7.73 14.97 6.76 13.3 5.79 14.97 7.73 14.97" />
                  <polygon className="cls-4" points="5.79 14.97 4.82 13.3 3.85 14.97 5.79 14.97" />
                  <polygon className="cls-4" points="3.85 14.97 2.88 13.3 1.91 14.97 3.85 14.97" />
                  <polygon className="cls-4" points="1.91 14.97 .94 13.3 -.02 14.97 1.91 14.97" />
                  ...
                  />
                  <polygon className="cls-5" points="31 18.31 30.04 16.64 29.07 18.31 31 18.31" />
                  <polygon
                    className="cls-4"
                  ...
                  />
                  <polygon className="cls-4" points="31 21.65 30.03 19.98 29.06 21.65 31 21.65" />
                  <polygon
                    className="cls-5"
                  ...
                  <polygon className="cls-4" points=".96 23.32 1.92 25 2.89 23.32 .96 23.32" />
                  ...
                  />
                  <polygon className="cls-4" points="14.53 23.32 15.5 25 16.47 23.32 14.53 23.32" />
                  <polygon
                    className="cls-4"
                  ...
                  />
                  <polygon className="cls-4" points="26.16 23.32 27.13 25 28.1 23.32 26.16 23.32" />
                  <polygon className="cls-4" points="28.1 23.32 29.07 25 30.04 23.32 28.1 23.32" />
                  <polygon
                    className="cls-5"
                  ...
                  />
                  <polygon className="cls-5" points="9.68 28.33 8.71 26.66 7.74 28.33 9.68 28.33" />
                  <polygon className="cls-5" points="7.74 28.33 6.77 26.66 5.8 28.33 7.74 28.33" />
                  ...
                  <polygon className="cls-5" points="4.83 30 3.86 28.33 2.89 30 4.83 30" />
                  <polygon className="cls-4" points="2.89 30 1.92 28.33 .95 30 2.89 30" />
